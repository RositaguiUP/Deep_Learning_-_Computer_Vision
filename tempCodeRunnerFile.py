...
def resizeImages(original_folder, resized_folder, target_size=(256, 256)):
...
def predictImages(input_folder, resized_folder, predicted_folder, version, target_size=(256, 256)):
...
# resized_out_folder = 'images/predictions/resized_output256'
